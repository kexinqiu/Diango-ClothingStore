...
def payments(request):
    ...
    for item in cart_items:
        ...
        #for storing many to many field, have to first save the object and then assign the value
    ...
    # data will go to the place where it comes from. it comes from the sentData method
